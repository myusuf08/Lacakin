//  
//  EventThisMonthViewController.swift
//  Lacakin
//
...
class EventThisMonthViewController: BaseViewController {

    @IBOutlet weak var emptyLabel: UILabel!
    @IBOutlet weak var tableView: UITableView!
    
    var viewModel: EventThisMonthViewModel!
    var coordinator: EventThisMonthCoordinator!
...
extension EventThisMonthViewController {
...
extension EventThisMonthViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.configureThisMonth(model: models)
        return cell
    }
...
extension EventThisMonthViewController: UITableViewDelegate {
